            ...
            <div data-aos="zoom-in-up"
                ...
                <section className="py-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-3 mx-auto w-full">
                        {
                            // services.services?.slice(3, 6).map(service => <ServiceCard key={service.id} service={service}></ServiceCard>)
            ...
            <div data-aos="flip-right"
                ...
                <section className="my-8 dark:bg-gray-800 dark:text-gray-100">
                    ...
                    <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                        {
                            tempts?.slice(3, 8).map((testimonial, index) => <div key={index} className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                                <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
                                    <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
                                        ...
                                        </svg>{testimonial?.testimonial}
                                        {/* </svg>{tempts[3].testimonial} */}
                                ...
                                <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-400 dark:text-gray-900">
                                    ...
                                    <p className="text-xl font-semibold leadi">{testimonial?.clientName}</p>
                                    {/* <p className="text-xl font-semibold leadi">{tempts[3]?.clientName}</p> */}
